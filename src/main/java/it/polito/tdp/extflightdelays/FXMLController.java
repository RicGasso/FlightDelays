...
public class FXMLController {
    ...
    void doTestConnessione(ActionEvent event) {
    	...
    	if(a2 == null) {
    		txtResult.setText("Selezionare un aeroporto di arrivo");
    		return;
    	}
    	...
    	if(percorso == null) {
    		txtResult.setText("i due nodi non sono collefati");
    	} else {
    		txtResult.appendText(a1 +" e "+ a2 +"sono collegati dal percorso\n\n");
